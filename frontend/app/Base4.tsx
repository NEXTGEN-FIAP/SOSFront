...
const Base4 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.baseName}>Showa 🇯🇵</Text>
      <Text style={styles.baseCoordinatesText}><Text style={styles.bold}>Coordenadas da Base:</Text>69° 00′ 15,6″ S, 39° 34′ 48,9″ L</Text>
