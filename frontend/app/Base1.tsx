...
const Base1 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.baseName}>Base Comandante Ferraz 🇧🇷</Text>
      <Text style={styles.baseCoordinatesText}><Text style={styles.bold}>Coordenadas da Base:</Text> 62° 05′ 00″ S, 58° 23′ 28,2″ O</Text>
