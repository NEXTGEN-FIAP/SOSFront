...
const Base5 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.baseName}>McMurdo 🇺🇸</Text>
      <Text style={styles.baseCoordinatesText}><Text style={styles.bold}>Coordenadas da Base:</Text> 77° 50′ 43,4″ S, 166° 40′ 11,2″ L</Text>
