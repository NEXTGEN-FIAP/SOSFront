...
const Base3 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.baseName}>Belgrano II 🇦🇷</Text>
      <Text style={styles.baseCoordinatesText}><Text style={styles.bold}>Coordenadas da Base:</Text> 77° 52′ 27,8″ S, 34° 37′ 14,9″ O</Text>
